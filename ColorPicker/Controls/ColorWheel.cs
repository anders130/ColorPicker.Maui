...
public class ColorWheel : ColorPickerViewBase
{
    ...
    protected override void LayoutChildren(double x, double y, double width, double height)
    {
        ...
        {
            if (Vertical)
                _luminositySlider.Layout(new Rect(bottom, x, sliderHeight, circleSize));
            else
                _luminositySlider.Layout(new Rect(x, bottom, circleSize, sliderHeight));
        ...
        {
            if (Vertical)
                _alphaSlider.Layout(new Rect(bottom, x, sliderHeight, circleSize));
            else
                _alphaSlider.Layout(new Rect(x, bottom, circleSize, sliderHeight));
        }
    }
